...
namespace ArchAngel.Providers.Database.Model
{
	...
	public class ScriptBase : ISerializable, IScriptBase
	{
		 ...
		 */
		[DotfuscatorDoNotRename]
		internal static int SerializationVersion = 6;
		[DotfuscatorDoNotRename]
		...
		public List<IUserOption> VirtualProperties
		{
			get
			{
		...
		public object GetUserOptionValue(string name)
		{
			...
			// individually.
			Interfaces.ProjectHelper.MyCurrentProject.PopulateVirtualProperties(this);
