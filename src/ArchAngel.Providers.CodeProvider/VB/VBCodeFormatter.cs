...
{
	class VBCodeFormatter : CodeFormatter
	{
		private readonly VBFormatSettings formatSettings;
		...
		public VBCodeFormatter(Document document, VBFormatSettings settings, Controller controller)
		{
		...
		public void SetFormatSettings(VBFormatSettings settings)
		{
