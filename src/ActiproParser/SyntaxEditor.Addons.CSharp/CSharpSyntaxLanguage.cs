...
namespace ActiproSoftware.SyntaxEditor {
	...
	public class TestClass : Control {
        ...
        /// <returns></returns>
        public bool IntelliPromptCompleteWord(SyntaxEditor syntaxEditor, SyntaxEditor syntaxEditorToDisplayIn)
        {
            return this.ShowIntelliPromptMemberList(DotNetLanguage.CSharp, syntaxEditor, true, syntaxEditorToDisplayIn);
        }
        ...
        /// <param name="syntaxEditor"></param>
        /// <returns></returns>
        public bool ShowIntelliPromptMemberList(SyntaxEditor syntaxEditor, SyntaxEditor syntaxEditorToDisplayIn) {
            return this.ShowIntelliPromptMemberList(DotNetLanguage.CSharp, syntaxEditor, false, syntaxEditorToDisplayIn);
        }
        ...
        {
            return ShowIntelliPromptParameterInfo(syntaxEditor, syntaxEditor);
        }
		...
		/// </remarks>
        public bool ShowIntelliPromptParameterInfo(SyntaxEditor syntaxEditor, SyntaxEditor syntaxEditorToDisplayIn)
        {
			...
			if (targetOffset != -1)
				return this.ShowIntelliPromptParameterInfoCore(DotNetLanguage.CSharp, syntaxEditor, syntaxEditorToDisplayIn, targetOffset, (token.ID == CSharpTokenID.OpenSquareBrace));
			else
				return false;
		}
