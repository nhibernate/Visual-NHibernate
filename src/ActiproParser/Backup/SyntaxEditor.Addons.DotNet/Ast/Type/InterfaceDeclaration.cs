...
namespace ActiproSoftware.SyntaxEditor.Addons.DotNet.Ast {
	...
	public class InterfaceDeclaration : TypeDeclaration {
		...
		public InterfaceDeclaration(Modifiers modifiers, QualifiedIdentifier name) : base(modifiers, name) {}
		...
		public override int ImageIndex {
			get {
				return AssemblyDomType.GetReflectionImageIndex(DomTypeType.Interface, this.AccessModifiers);
			}
		}
		...
		public override DotNetNodeType NodeType { 
			get {
				return DotNetNodeType.InterfaceDeclaration;
			}
		}
