...
namespace ActiproSoftware.SyntaxEditor.Addons.DotNet.Ast {
	...
	/// </summary>
	public class DestructorDeclaration : TypeMemberDeclaration, IBlockAstNode, ICollapsibleNode, IDomMember {
		...
		public const byte StatementContextID = TypeMemberDeclaration.TypeMemberDeclarationContextIDBase;
		...
		public DestructorDeclaration(Modifiers modifiers, QualifiedIdentifier name) : base(modifiers, name) {}
		...
		public override DotNetNodeType NodeType { 
			get {
				return DotNetNodeType.DestructorDeclaration;
			}
		}
		...
		public IAstNodeList Statements {
			get {
				return new AstNodeListWrapper(this, DestructorDeclaration.StatementContextID);
			}
		}
