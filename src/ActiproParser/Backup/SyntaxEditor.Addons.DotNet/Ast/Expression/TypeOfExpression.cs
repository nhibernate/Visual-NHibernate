...
namespace ActiproSoftware.SyntaxEditor.Addons.DotNet.Ast {
	...
	public class TypeOfExpression : Expression {
		...
		public TypeOfExpression(TypeReference typeReference, TextRange textRange) : base(textRange) {
		...
		public override DotNetNodeType NodeType { 
			get {
				return DotNetNodeType.TypeOfExpression;
			}
		}
		...
		public TypeReference TypeReference {
			get {
				return this.GetChildNode(TypeOfExpression.TypeReferenceContextID) as TypeReference;
			}
			set {
				this.ChildNodes.Replace(value, TypeOfExpression.TypeReferenceContextID);
			}
		}
