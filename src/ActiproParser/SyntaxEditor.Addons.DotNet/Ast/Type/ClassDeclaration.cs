...
namespace ActiproSoftware.SyntaxEditor.Addons.DotNet.Ast {
	...
	public class ClassDeclaration : TypeDeclaration {
		...
		public ClassDeclaration(Modifiers modifiers, QualifiedIdentifier name) : base(modifiers, name) {}
		...
		public override DotNetNodeType NodeType { 
			get {
				return DotNetNodeType.ClassDeclaration;
			}
		}
		...
		public override int ImageIndex {
			get {
				return AssemblyDomType.GetReflectionImageIndex(DomTypeType.Class, this.AccessModifiers);
			}
		}
