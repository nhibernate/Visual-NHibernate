...
namespace ActiproSoftware.SyntaxEditor.Addons.DotNet.Ast {
	...
	/// </summary>
	public class GetXmlNamespaceExpression : ChildExpressionExpression {
		...
		public GetXmlNamespaceExpression(Expression expression, TextRange textRange) : base(expression, textRange) {}
		...
		public override DotNetNodeType NodeType { 
			get {
				return DotNetNodeType.GetXmlNamespaceExpression;
			}
		}
