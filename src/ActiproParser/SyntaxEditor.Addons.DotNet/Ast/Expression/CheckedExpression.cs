...
namespace ActiproSoftware.SyntaxEditor.Addons.DotNet.Ast {
	...
	/// </summary>
	public class CheckedExpression : ChildExpressionExpression {
		...
		public CheckedExpression(Expression expression, TextRange textRange) : base(expression, textRange) {}
		...
		public override DotNetNodeType NodeType { 
			get {
				return DotNetNodeType.CheckedExpression;
			}
		}
