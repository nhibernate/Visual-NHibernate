...
namespace ActiproSoftware.SyntaxEditor.Addons.DotNet.Ast {
	...
	/// <summary>
	/// Represents a section of using directives for a <see cref="CompilationUnit"/>.
	/// </summary>
	public class UsingDirectiveSection : AstNode, ICollapsibleNode {
		...
		public IAstNodeList Directives {
			get {
				return new AstNodeListWrapper(this, UsingDirectiveSection.DirectiveContextID);
			}
		}
		...
		public override string Key {
			get {
				...
				return namespaceName + "(UsingDirectiveSection)"; 
			}
		}
		...
		public override DotNetNodeType NodeType { 
			get {
				return DotNetNodeType.UsingDirectiveSection;
			}
		}
