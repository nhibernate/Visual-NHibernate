...
namespace Slyce.Common.Controls.Diagramming.Shapes
{
    public partial class TableShape : Shape
    {
        ...
        public TableShape(string name, bool isEmpty)
        {
            InitializeComponent();
        ...
        private void SetStyle()
        {
            ...
            {
                labelX1.BackgroundStyle.BackColor = Color.Maroon;
                labelX1.BackgroundStyle.BackColor2 = Color.LightCoral;
