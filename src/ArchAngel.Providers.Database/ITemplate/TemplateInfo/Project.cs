...
namespace Slyce.TemplateInfo
{
    ...
    public class Project : Slyce.ITemplate.IProject
    {
        ...
        private List<ArchAngel.Actions.BaseAction> m_actions = new List<ArchAngel.Actions.BaseAction>();
        ...
        public List<ArchAngel.Actions.BaseAction> Actions
        {
        ...
        public List<ArchAngel.Actions.BaseAction> PreActions
        {
            get
            {
                List<ArchAngel.Actions.BaseAction> preActions = new List<ArchAngel.Actions.BaseAction>();
                Type generationType = typeof(ArchAngel.Actions.GenerationStepAction);

                for (int i = 0; i < Actions.Count; i++)
                {
                    ArchAngel.Actions.BaseAction action = Actions[i];
        ...
        public List<ArchAngel.Actions.BaseAction> PostActions
        {
            get
            {
                List<ArchAngel.Actions.BaseAction> postActions = new List<ArchAngel.Actions.BaseAction>();
                Type generationType = typeof(ArchAngel.Actions.GenerationStepAction);
